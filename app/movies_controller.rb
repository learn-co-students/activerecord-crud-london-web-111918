...
def can_find_using_where_clause_and_be_sorted
  ...
  # Movie.all.select do |movie| movie if movie.release_date > 2002.sort {|movie_a, movie_b| movie_b.release_date <=> movie_a.release_date}
  Movie.where("release_date > 2002").order("release_date DESC") # A standard SQL query is much clearer and half the length of the pure Ruby statement above
end
